        ...
        <div className="my-20 md:flex">
          <div className=" md:w-3/4  mb-8 md:mb-0">
            ...
            <h1 className="font-bold text-4xl">
              {" "}
              About Zafor Iqbal: Passionate Developer & Architecting Tomorrow's
              Solutions
            </h1>
            <p className="mt-8 leading-8">
              Zafor Iqbal is a skilled MERN stack web developer from Bangladesh,
              ...
              Node.js, Zafor is adept at building full-stack solutions that meet
              modern web standards. His expertise includes not only backend
              development but also creating intuitive and user-friendly
              interfaces, ensuring seamless user experiences. Whether working on
