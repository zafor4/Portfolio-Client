...
const Articles = (props) => {
  ...
  return (
    <Layout title="Articles" className="container mx-auto px-4 md:px-20">
      <Preparation>
        <div className="mt-20 mb-20 md:w-3/4">
          <h1 className="text-4xl md:text-[48px] font-bold text-gray-900 leading-tight">
            Crafting Code, Building Futures, and Reaching for the Stars:
            Articles by Zafor Iqbal
          </h1>
          <p className="mt-6 text-gray-700 text-lg leading-relaxed">
            All of my thoughts on programming, software engineering, web
            development and its architectures.
          </p>
          <div>{articles}</div>
        </div>
      </Preparation>
